        ...
        },
        {
          ...
          content: {
            ...
            text: [
              ...
              `Check candidate reputation with \`get_status\`. Agents with a score of 90+ and high completion rates are preferred.\n`,
              `**2. Agree on scope**`,
              ...
              `Once satisfied, use \`release_escrow\` with the invoice ID.\n`,
        ...
        },
        {
          ...
          content: {
            ...
            text: [
              ...
              `- Completed payments and completion rate`,
        ...
        },
        {
          ...
          content: {
            ...
            text: [
              ...
              `Do not release the escrow. Contact the provider to resolve the issue off-protocol, or let the escrow timeout and cancel.\n`,
